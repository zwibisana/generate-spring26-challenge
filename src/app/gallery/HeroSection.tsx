  ...
  return (
    <div className="relative header bg-[#18181B] border border-[#27272A] p-8 rounded-[2px]">
      ...
      <div className="flex flex-wrap gap-3 mt-6">
        <div className="flex items-center gap-1 px-2 py-1 text-[12px] text-[#9F9FA9] bg-[#27272A] outline-[#3F3F46] border-solid outline outline-[1px]">
        ...
        <div className="flex items-center gap-1 px-2 py-1 text-[12px] text-[#00C950] bg-[#27272A] outline-[#3F3F46] border-solid outline outline-[1px]">
