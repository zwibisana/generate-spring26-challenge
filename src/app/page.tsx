    ...
    <div>
      <div className="relative bg-[#18181a] border-solid outline outline-[#27272A]">
        <div className="absolute top-0 left-0 right-0 flex justify-between px-2 py-1">
          {/* Note: Make Button to Rare Manuscript */}
          ...
          {/* Note: Make Button to China Vase */}
      ...
      <div className="mx-[30px] md:mx-[100px] mt-10 flex flex-col gap-y-10">
        ...
        <div className="relative header bg-[#18181B] border border-[#27272A] p-8 rounded-[2px]">
          <h1 className="text-left text-[48px] font-bold uppercase tracking-[2.4] leading-[1]">The Dark Vault</h1>
          <h3 className="text-left text-[14px] text-[#71717B] tracking-[1.4] mt-4">STOLEN GOODS • NO QUESTIONS ASKED • CRYPTO ONLY</h3>
        ...
        {/* Red Text */}
        <div className="bg-[#460a08] px-2 py-2 border-solid outline outline-[#82181A] text-[#FF6467] text-[12px]">
